  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#2c2c2c]/90 backdrop-blur-sm border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-40">
        <img src={pontLogo} alt="Pont Consultoria" className="h-36 w-auto" />
...
function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-[#2c2c2c] pt-40">
