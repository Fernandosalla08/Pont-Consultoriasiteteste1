      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="text-sm bg-[#1034A6] hover:bg-[#1034A6] text-black font-bold px-5 py-2 transition-colors uppercase tracking-wider"
          >
            Fale Conosco
          </button>
        </nav>
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-black pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <motion.p
          ...
          className="text-[#1034A6] text-sm font-bold tracking-[0.25em] uppercase mb-6"
        >
        ...
        >
          ...
          AUTOMATIZE.{" "}
          <br className="hidden md:block" />
          <em className="not-italic text-[#1034A6]">ACELERE.</em>
        </motion.h1>
        ...
        >
          {[
            ...
            <div key={m.label} className="border-l-2 border-[#1034A6] pl-4">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#1034A6] hover:bg-[#1034A6] text-black font-bold px-8 py-4 text-sm uppercase tracking-wider transition-all"
          >
  ...
  return (
    <section id="serviços" className="bg-[#090909] border-t border-white/5 py-28">
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          <motion.p variants={fadeUp} className="text-[#1034A6] text-xs font-bold tracking-[0.3em] uppercase mb-3">
            O Que Fazemos
          </motion.p>
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-4">
            NOSSOS <em className="not-italic text-[#1034A6]">SERVIÇOS</em>
          </motion.h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5">
          {services.map((s, i) => (
            <Section key={i}>
              ...
              >
                <div className="w-12 h-12 border border-[#1034A6]/40 flex items-center justify-center mb-6 group-hover:border-[#1034A6] group-hover:bg-[#1034A6]/10 transition-all">
                  <s.icon className="text-[#1034A6]" size={20} />
                </div>
  ...
  return (
    <section id="vsm-&-lean" className="bg-black border-t border-white/5 py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Section>
          <motion.div variants={fadeUp} className="bg-[#1034A6]/10 border-l-4 border-[#1034A6] p-6 mb-10 max-w-xl">
            ...
            <ul className="space-y-2 mt-3">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-sm text-white/60">
                  <FiCheckCircle className="text-[#1034A6] mt-0.5 shrink-0" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          {vsmCards.map((c, i) => (
            <Section key={i}>
              <motion.div variants={fadeUp} custom={i} className="bg-black p-8 hover:bg-[#0a0a0a] transition-colors h-full">
                <c.icon className="text-[#1034A6] mb-4" size={22} />
        ...
        <Section>
          <motion.div variants={fadeUp} className="text-center">
            <div className="text-5xl md:text-7xl font-black text-[#1034A6]">40–70%</div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-12">
            NÃO AUTOMATIZE{" "}
            <em className="not-italic text-[#1034A6]">DESPERDÍCIOS.</em>
            <br />
            AUTOMATIZE{" "}
            <em className="not-italic text-[#1034A6]">PROCESSOS ENXUTOS.</em>
          </motion.h2>
        </Section>
          ...
          {steps.map((s, i) => (
            <Section key={i}>
              <motion.div variants={fadeUp} custom={i} className="bg-[#050505] p-10 relative h-full">
                ...
                {i < steps.length - 1 && (
                  <div className="hidden md:block absolute -right-3 top-1/2 -translate-y-1/2 z-10 text-[#1034A6]">
        ...
        <Section>
          <motion.p variants={fadeUp} className="text-white/50 text-base max-w-3xl leading-relaxed border-l-4 border-[#1034A6] pl-6">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-16">
            A ABORDAGEM <em className="not-italic text-[#1034A6]">TEORIA DAS RESTRIÇÕES</em>
          </motion.h2>
        </Section>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            {tocSteps.map((s, i) => (
              <Section key={i}>
                <motion.div variants={fadeUp} custom={i} className="flex gap-5 py-7 group hover:bg-white/2 transition-colors px-2">
                  <div className="shrink-0 w-10 h-10 border border-[#1034A6]/30 group-hover:border-[#1034A6] group-hover:bg-[#1034A6]/10 flex items-center justify-center transition-all">
                    <s.icon className="text-[#1034A6]" size={16} />
                  </div>
                  <div>
                    <div className="text-[#1034A6] text-xs font-bold tracking-widest mb-1">0{i + 1}</div>
          ...
          <Section>
            <motion.div variants={fadeUp} className="border border-white/10 p-8 h-fit sticky top-24">
              ...
              <div className="text-white font-black text-xl uppercase mb-6">ENCONTRE O <span className="text-[#1034A6]">GARGALO</span></div>
                ...
                {throughputSteps.map((s) => (
                  <div key={s.label}>
                    ...
                    <div className="h-1.5 bg-white/5 overflow-hidden">
                      <div
                        className={`h-full transition-all ${s.warn ? "bg-red-500" : "bg-[#1034A6]/60"}`}
                        style={{ width: `${s.pct}%` }}
                      />
                    </div>
                  </div>
    ...
    <section className="bg-[#050505] border-t border-white/5 py-28">
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-4">
            A <em className="not-italic text-[#1034A6]">BÚSSOLA</em> FINANCEIRA
          </motion.h2>
          ...
          <motion.div variants={fadeUp} className="flex flex-col md:flex-row items-center gap-0 mb-16 overflow-x-auto">
            {flow.map((label, i) => (
              <React.Fragment key={label}>
                <div className={`shrink-0 px-6 py-4 border font-bold text-sm uppercase tracking-wider whitespace-nowrap ${i === 1 ? "border-[#1034A6] bg-[#1034A6]/10 text-[#1034A6]" : "border-white/20 bg-white/5 text-white"}`}>
                  {label}
                </div>
                {i < flow.length - 1 && (
                  <FiArrowRight className="text-[#1034A6] shrink-0 rotate-90 md:rotate-0 my-1 md:my-0 mx-0 md:mx-1" size={16} />
                )}
              </React.Fragment>
            ))}
          </motion.div>
          ...
          {[
            ...
            <Section key={i}>
              <motion.div variants={fadeUp} custom={i} className="bg-[#050505] p-8 h-full hover:bg-[#0a0a0a] transition-colors">
                <div className="w-2 h-2 bg-[#1034A6] rounded-full mb-5" />
                <h3 className="text-white font-bold uppercase tracking-tight mb-3">{c.title}</h3>
                <p className="text-white/50 text-sm leading-relaxed">{c.desc}</p>
              </motion.div>
            </Section>
    ...
    <section id="indústrias" className="bg-black border-t border-white/5 py-28">
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-4">
            INDÚSTRIAS <em className="not-italic text-[#1034A6]">ALVO</em>
          </motion.h2>
          <motion.p variants={fadeUp} custom={2} className="text-white/50 text-lg max-w-2xl mb-16">
          ...
          {industries.map((ind, i) => (
            <Section key={i}>
              <motion.div variants={fadeUp} custom={i} className="bg-black p-8 hover:bg-[#0a0a0a] transition-colors group h-full">
                <ind.icon className="text-[#1034A6] mb-5" size={22} />
                <h3 className="text-white font-bold uppercase tracking-tight mb-3 group-hover:text-[#1034A6] transition-colors">{ind.title}</h3>
    ...
    <section className="bg-[#050505] border-t border-white/5 py-28">
      <div className="max-w-7xl mx-auto px-6">
        <Section>
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-16">
            POR QUE ESCOLHER A <em className="not-italic text-[#1034A6]">PONT</em>
          </motion.h2>
        </Section>
        ...
        {/* Quote */}
        <Section>
          <motion.blockquote variants={fadeUp} className="mt-20 border-l-4 border-[#1034A6] pl-8 max-w-3xl">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <Section>
            ...
            <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-6xl font-black uppercase tracking-tight text-white mb-6">
              VAMOS FALAR SOBRE O SEU <em className="not-italic text-[#1034A6]">DESAFIO</em>
            </motion.h2>
            ...
            <motion.div variants={fadeUp} custom={3} className="flex items-center gap-4">
              <FiMail className="text-[#1034A6]" size={20} />
            ...
            <motion.div variants={fadeUp} className="border border-white/10 p-8">
              {sent ? (
                <div className="text-center py-10">
                  <FiCheckCircle className="text-[#1034A6] mx-auto mb-4" size={40} />
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  {[
                    ...
                    <div key={f.id}>
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 focus:border-[#1034A6] text-white placeholder:text-white/20 px-4 py-3 text-sm outline-none transition-colors"
                        required
                      />
                    </div>
                  ))}
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/5 border border-white/10 focus:border-[#1034A6] text-white placeholder:text-white/20 px-4 py-3 text-sm outline-none transition-colors resize-none"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-[#1034A6] hover:bg-[#1034A6] text-black font-bold py-4 text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2"
                  >
    ...
    <footer className="bg-[#030303] border-t border-white/5">
      ...
      <div className="border-b border-white/5 py-16">
        ...
        >
          ...
          <div className="flex flex-col items-center text-white/40 group-hover:text-[#1034A6] transition-colors duration-300">
          ...
          <img
            ...
            alt="Pont Automação"
            className="h-40 w-auto opacity-70 group-hover:opacity-100 transition-opacity duration-300"
          />
        </a>
      </div>
